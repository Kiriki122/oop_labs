...
namespace BazaGRUD.Controllers
{
    public class StudentToGroupsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["GroupID"] = new SelectList(_context.Groups, "Id", "Name", studentToGroup.GroupID);
            ViewData["StudentID"] = new SelectList(_context.Students, "Id", "Name", studentToGroup.StudentID);
            return View(studentToGroup);
        }
